...
@Service
@Slf4j
public class DaAnSportCenterBookingImpl extends SportCenterBookingImpl implements IBookingService {

    protected DaAnSportCenterBookingImpl(MailUtil mailUtil, @Value("${sport.center.username}") String username) {
        super(mailUtil, username);
        this.SETTING = SportCenterSettingEnum.DA_AN;
    }
}
