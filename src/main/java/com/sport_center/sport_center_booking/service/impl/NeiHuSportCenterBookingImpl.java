...
@Service
@Slf4j
public class NeiHuSportCenterBookingImpl extends SportCenterBookingImpl implements IBookingService {
    
    public NeiHuSportCenterBookingImpl(MailUtil mailUtil, @Value("${sport.center.username}") String username) {
        super(mailUtil, username);
        this.SETTING = SportCenterSettingEnum.NEI_HU;
    }
}
